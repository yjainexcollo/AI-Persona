...
import { Save as SaveIcon, Settings as SettingsIcon, Delete as DeleteIcon } from "@mui/icons-material";
import CommonNavbar from "../components/CommonNavbar";
import AdminSidebar from "../components/sidebar/AdminSidebar";
import { Drawer } from "@mui/material";
import { getWorkspaceDetails, updateWorkspace, requestWorkspaceDeletion, type WorkspaceData } from "../services/workspaceService";
...
const WorkspaceSettingsPage: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setSuccess("Workspace deletion requested successfully. The workspace will be permanently deleted in 30 days.");
      ...
      setError(err instanceof Error ? err.message : "Failed to request workspace deletion");
    } finally {
      setDeleting(false);
    }
  };
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      <Box sx={{ flex: 1, display: "flex", flexDirection: "column", ml: { xs: 0, md: '220px' } }}>
        <CommonNavbar onToggleSidebar={() => setSidebarOpen(true)} />
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <Typography 
                        variant="body1" 
                        color={workspace.isActive ? "success.main" : "error.main"}
                      >
